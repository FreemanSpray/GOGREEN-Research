...
class GOGREEN:
    ...
    def MSRfit(self, data:list, useLog:list=[False, False], axes:list=None, row:int=None, col:int=None, allData:bool=False, onlyMembers:bool=True, additionalCriteria:list=None, useStandards:bool=True, SFRrestrict:str=None):
        """
        ...
        # Plot all clusters on the same plot            
            ...
            if fitLine == True:
                ...
                if colorType == 'passive':
                    self.MSRfit([], useLog, allData=True, onlyMembers=onlyMembers, additionalCriteria=additionalCriteria, useStandards=useStandards, SFRrestrict='passive')
                    self.MSRfit([], useLog, allData=True, onlyMembers=onlyMembers, additionalCriteria=additionalCriteria, useStandards=useStandards, SFRrestrict='starForming')
                else:
