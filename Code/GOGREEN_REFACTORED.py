...
class GOGREEN:
    ...
    def MSRfit(self, data:list, useLog:list=[False, False], axes:list=None, row:int=None, col:int=None, allData:bool=False, useMembers:str='only', additionalCriteria:list=None, useStandards:bool=True, typeRestrict:str=None, color:str=None):
        """
    ...
    def getRatio(self, x:float=None, y:float=None) -> list:
        ...
        mMemberQ, bMemberQ = self.MSRfit(data=None, useLog=[True, True], allData=True, useMembers='only', typeRestrict='Quiescent')
        mMemberSF, bMemberSF = self.MSRfit(data=None, useLog=[True, True], allData=True, useMembers='only', typeRestrict='Star-Forming')
        mNonMemberQ, bNonMemberQ = self.MSRfit(data=None, useLog=[True, True], allData=True, useMembers='not', typeRestrict='Quiescent', color='orange')
        mNonMemberSF, bNonMemberSF = self.MSRfit(data=None, useLog=[True, True], allData=True, useMembers='not', typeRestrict='Star-Forming', color='green')
        plt.xlim(9.5, 11.5)
        plt.ylim(-0.75, 1.25)
        plt.legend()
        if x != None:
